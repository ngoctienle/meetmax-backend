variable "aws_region" {
  description = "Region in which AWS Resource are created"
  type        = string
...
variable "ec2_iam_role_name" {
  ...
  type        = string
  default     = "meetmax-api-ec2-role"
}

variable "ec2_iam_role_policy_name" {
  description = "EC2 IAM Role Policy Name"
  type        = string
  default     = "meetmax-api-ec2-role-policy"
}

variable "ec2_instance_profile_name" {
  description = "EC2 Instance Profile Name"
  type        = string
  default     = "meetmax-api-ec2-instance-profile"
}
...
variable "code_deploy_role_name" {
  ...
  type        = string
  default     = "meetmax-api-codedeploy-role"
}
